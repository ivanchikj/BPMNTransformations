...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "transformations";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "transformations.war")
            ...
            .addPackages(false, "bpmn.transformations") // not recursive to skip package 'nonarquillian'
