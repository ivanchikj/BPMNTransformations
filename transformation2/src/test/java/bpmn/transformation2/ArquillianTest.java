...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "transformation2";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "transformation2.war")
            ...
            .addPackages(false, "bpmn.transformation2") // not recursive to skip package 'nonarquillian'
